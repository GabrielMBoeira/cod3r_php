...
$conexao = novaConexao();
// print_r(get_class_methods($conexao)); MOSTRAR METODOS DE UMA CLASSE $conexao;

if($conexao->exec($sql)) { //exec retorna true or false
    $id = $conexao->lastInsertId(); //pegar o id que foi definido como autoincrement
