...
$sql = "SELECT * FROM cadastro LIMIT :qtde OFFSET :inicio"; //sql = "SELECT * FROM cadastro LIMIT ? OFFSET ?"; // LIMIT => linhas  / OFFSET = apartir de quando ele vai pegar a consulta
