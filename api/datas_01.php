...
<?php
echo time() . '<br>'; //Retorna a quantidades de segundos dede o marco 0 01/01/1970 (Meridiano de greenwich 0 -> brasil -3gmt japao +7gmt)
echo date('D, d \d\e M \d\e Y H:i A') . '<br>'; // o \d\e => de    (usar contra-barra para scape)
